...
BATCH_SIZE = 90
EPOCHS = 30
AUGMENTED = 'french_augmentation.csv'
...
matched_entries = augmented_df[augmented_df["Unnamed: 0"].isin(train_df["Unnamed: 0"])]

train_df = pd.concat([train_df, matched_entries], ignore_index=True)
